...
public class WxUserController extends BaseController
{
     ...
     * 查询微信用户列表
     */
    @PreAuthorize("@ss.hasPermi('front:wxuser:list')")
    @GetMapping("/list")
     ...
     * 导出微信用户列表
     */
    @PreAuthorize("@ss.hasPermi('front:wxuser:export')")
     ...
     * 获取微信用户详细信息
     */
    @PreAuthorize("@ss.hasPermi('front:wxuser:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增微信用户
     */
    @PreAuthorize("@ss.hasPermi('front:wxuser:add')")
     ...
     * 修改微信用户
     */
    @PreAuthorize("@ss.hasPermi('front:wxuser:edit')")
     ...
     * 删除微信用户
     */
    @PreAuthorize("@ss.hasPermi('front:wxuser:remove')")
